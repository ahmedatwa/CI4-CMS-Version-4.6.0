...
/* User/user_list.twig */
class __TwigTemplate_e808454e0d44ce9df94c03cfb8081600 extends Template
{
...
\t\t\t\t\t\t<a href=\"";
        ...
        yield "\" class=\"btn btn-danger disabled\" name=\"button-delete\" form=\"form-user\">
...
\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 98
            if (CoreExtension::inFilter(CoreExtension::getAttribute($this->env, $this->source, $context["user"], "user_id", [], "any", false, false, false, 98), ($context["selected"] ?? null))) {
                // line 99
                yield "\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"selected[]\" value=\"";
                yield CoreExtension::getAttribute($this->env, $this->source, $context["user"], "user_id", [], "any", false, false, false, 99);
                yield "\" checked=\"checked\"/>
\t\t\t\t\t\t\t\t\t\t\t\t";
            } else {
                // line 101
                yield "\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"selected[]\" value=\"";
                yield CoreExtension::getAttribute($this->env, $this->source, $context["user"], "user_id", [], "any", false, false, false, 101);
                yield "\"/>
\t\t\t\t\t\t\t\t\t\t\t\t";
            }
            // line 103
...
\t\t\t\t\t\t\t\t\t\t\t<td>";
            // line 104
            yield CoreExtension::getAttribute($this->env, $this->source, $context["user"], "name", [], "any", false, false, false, 104);
            yield "</td>
\t\t\t\t\t\t\t\t\t\t\t<td>";
            // line 105
            yield CoreExtension::getAttribute($this->env, $this->source, $context["user"], "email", [], "any", false, false, false, 105);
            yield "</td>
\t\t\t\t\t\t\t\t\t\t\t<td>";
            // line 106
            yield CoreExtension::getAttribute($this->env, $this->source, $context["user"], "status", [], "any", false, false, false, 106);
            yield "</td>
\t\t\t\t\t\t\t\t\t\t\t<td>";
            // line 107
            yield CoreExtension::getAttribute($this->env, $this->source, $context["user"], "date_added", [], "any", false, false, false, 107);
            yield "</td>
\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-center\">
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
            // line 109
            yield CoreExtension::getAttribute($this->env, $this->source, $context["user"], "edit", [], "any", false, false, false, 109);
...
\t\t</div>
\t</main>
{{ footer }}", "User/user_list.twig", "/Users/ahmedatwa/Sites/project-root/admin/app/Views/User/user_list.twig");
    }
}
